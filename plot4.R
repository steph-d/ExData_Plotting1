...
par(mfrow=c(2,2))
plot(d$DT, d$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex.axis=0.9)
plot(d$DT, d$Voltage, xlab="datetime", ylab="Voltage", type="l")
plot(d$DT, d$Sub_metering_1, col="black", type="l", ylab="Energy sub metering", xlab="",cex.axis=0.9)
lines(d$DT, d$Sub_metering_2, col="red", type="l")
lines(d$DT, d$Sub_metering_3, col="blue", type="l")
legend("topright", legend=name[7:9], lty=1, col=c("black","red","blue"),cex=0.8,bty="n")
plot(d$DT,d$Global_reactive_power, xlab="datetime",ylab="Global_reactive_power",type="l")
dev.off()
